@echo off
REM =============================================================================
REM Thinklet Streaming Environment - Auto-Elevated Start (Rancher Desktop)
REM 
...
title Thinklet Streaming Environment Startup (Rancher Desktop)

echo.
echo ============================================================
echo  Thinklet Streaming Environment - Startup (Rancher Desktop)
echo ============================================================
echo.
...
PowerShell.exe -ExecutionPolicy Bypass -File "%~dp0start-streaming-rancher.ps1"
